...
function addTask() {
    ...
    document.getElementsByClassName("save-task-button")[0].addEventListener('onclick', (event) => {
        finishAdd(false);
    });
    //  });
    // }
...
function finishAdd(don) {
    ...
    editBtn.addEventListener('click', (e) => {
        ...
        console.log(row);
        let newValues = row.getElementsByTagName('td');
        // console.log(values[0]);
        let cell1 = "<td><input type='text' class='new-task'" + " value='" + newValues[0].innerText + "'></td>";
        let cell2 = "<td><input type='text' class='new-task'" + " value='" + newValues[1].innerText + "'></td>";
        let cell3 = "<td>" + statusValue(newValues[2].childNodes[0].innerText).outerHTML + "</td>";
        // row.closest('tr').remove();
        console.log(cell3);

        let newRow = document.createElement("tr");

        newRow.innerHTML = cell1 + cell2 + cell3 + "<td>" + newValues[3].innerHTML + "</td>" + "<td>" + newValues[4].innerHTML + "</td>";
    ...
    delBtn.addEventListener('click', (e) =>{
        let delRow = e.target.closest('tr');
        delRow.remove();
    });
    console.log(delBtn);
